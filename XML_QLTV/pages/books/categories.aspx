<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="categories.aspx.cs" Inherits="XML_QLTV.pages.books.categories" EnableViewState="true" %>
                                    ...
                                    <div class="e-panel card">
                                        <div class="card-body">
                                            <div class="card-title">
                                                <h6 class="mr-2"><span>Thể loại</span><small class="px-1">Danh sách thể loại</small></h6>
                                            </div>
                                            <div class="e-table">
                                                <div class="table-responsive table-lg mt-3">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                                                <th>STT</th>
                                                                <th class="max-width">Thể loại</th>
                                                                <th>Hành động</th>
                                                            </tr>
                                                        </thead>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center px-xl-3">
                                                <button class="btn btn-success btn-block" type="button" data-toggle="modal" data-target="#user-form-modal">Thêm thể loại</button>
                                            </div>
                                            <br />
                                            <div class="text-center px-xl-3">
                                                <asp:Button
                                            ...
                                            <div class="py-1">
                                                ...
                                                <div class="row">
                                                    <div class="col d-flex justify-content-end">
                                                        <button class="btn btn-primary" type="submit" runat="server" onserverclick="AddAuthor_Click">Thêm thể loại</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
