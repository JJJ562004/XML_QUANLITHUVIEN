<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="categories.aspx.cs" Inherits="XML_QLTV.pages.books.authors" %>
...
<body class="with-welcome-text">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">Giao diện quản lý <span class="text-black fw-bold">Thể loại sách</span></h1>
                        <h3 class="welcome-sub-text">Thêm, sửa, xoá thông tin của thể loại sách tại thư viện</h3>
                    </li>
                </ul>
    ...
    <script  type="module" src="../../assets/js/util.js"></script>
    <script  type="module" src="../../assets/js/tab.js"></script>
    <script  type="module" src="../../assets/js/tooltip.js"></script>
    <script  type="module" src="../../assets/js/popover.js"></script>
    <script  type="module" src="../../assets/js/index.js"></script>
    <script  type="module" src="../../assets/js/dropdown.js"></script>
    <script  type="module" src="../../assets/js/collapse.js"></script>
    <script  type="module" src="../../assets/js/carousel.js"></script>
    <script  type="module" src="../../assets/js/button.js"></script>
    <script  type="module" src="../../assets/js/alert.js"></script>
