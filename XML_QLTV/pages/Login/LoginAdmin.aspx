<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginAdmin.aspx.cs" Inherits="XML_QLTV.pages.Login.LoginAdmin" %>
...
<body>
    <section class="container">
        <div class="login-container">
            ...
            <div class="form-container">
                ...
                <form id="studentForm"> 
                    <input type="text" id="studentID" name="StudentID" placeholder="Mã cán bộ">
                ...
                <div class="register-forget opacity">
                    ...
                    <a href="Login.aspx">Đăng nhập Sinh Viên</a>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById("studentForm").addEventListener("submit", function (event) {
            ...
            if (isValid) {
                // Chuyển đến trang library (Cập nhật đường dẫn cho chính xác)
                window.location.href = "../../AdminDashBoard.aspx";  
            } else {
                // Hiển thị lỗi nếu thông tin sai
                errorMessage.textContent = "Staff ID hoặc Phone Number không đúng. Vui lòng thử lại!";
            }
        });
    </script>
</body>
