<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDashBoard.aspx.cs" Inherits="XML_QLTV.AdminDashBoard" %>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="pages/books/authors.aspx">Quản lý tác giả</a></li>
                                <li class="nav-item"><a class="nav-link" href="pages/books/categories.aspx">Quản lý thể loại</a></li>
                                <li class="nav-item"><a class="nav-link" href="pages/books/books.aspx">Quản lý sách</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
